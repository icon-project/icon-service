...
class Engine(EngineBase):
    ...
    def handle_set_prep(self, context: 'IconScoreContext', params: dict):
        ...
        irep = ret_params.get(ConstantKeys.IREP)
        if irep:
