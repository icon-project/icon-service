...
class IconServiceEngine(ContextContainer):
    ...
    def open(self, conf: 'IconConfig') -> None:
        ...
        IconScoreContext.iiss_engine: 'Engine' = self._iiss_engine
        ...
        Engine.icx_storage: 'IcxStorage' = self._icx_storage
