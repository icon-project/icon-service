...
case "$action" in
  ...
  tokenbal|tokenBalance )
      PARAMS='{"jsonrpc": "2.0", "method": "icx_call", "id": 50889, "params": { "from": "hx0000000000000000000000000000000000000000", "to": "cxb133709a91eb8bbc762808a87072287432523be5", "data_type": "call", "data": {"method": "balance_of", "params": {"addr_from": "hx1111111111111111111111111111111111111111"}}}}'
  ;;
