...
from iconservice.iconscore.icon_score_base import IconScoreBase, eventlog, external
...
from tests.legacy_unittest.mock_generator import (
    generate_service_engine,
    generate_inner_task,
    create_request,
    ReqData,
    clear_inner_task,
...
class TestScoreResult(unittest.TestCase):
    def setUp(self):
        ...
        self._icon_service_engine._charge_transaction_fee = Mock(return_value=({}, 0))
        ...
        self._mock_context._inv_container = (
            IconScoreContext.engine.inv.inv_container.copy()
        )
    ...
    def test_install_result(self):
        ...
        tx_result = self._icon_service_engine._handle_icx_send_transaction(
            self._mock_context,
            {
                ...
                "dataType": "deploy",
                "timestamp": 0,
                "data": {"contentType": "application/tbears", "content": "/home/haha"},
            },
        )
