...
def set_default_context_storage_and_engine():
    ...
    temp_storage, temp_engine = (
        ContextStorage.__new__.__defaults__,
        ContextEngine.__new__.__defaults__,
    )
    ...
    yield
    ContextStorage.__new__.__defaults__, ContextEngine.__new__.__defaults__ = (
        temp_storage,
        temp_engine,
    )
