...
class TestIntegrateStep(TestIntegrateBase):
    ...
    def test_system_score(self):
        ...
        prev_block, _ = self._call_system_score(func_name="func_name")
        self.assertEqual(True, context.step_trace_flag)
        ...
        # TEST: charge CONTRACT_CALL to None dataType
        prev_block, _ = self._call_system_score(func_name="func_name",
        ...
        # TEST: do not charge CONTRACT_CALL to None dataType after Revision.SYSTEM_SCORE_ENABLED
