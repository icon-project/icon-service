...
class TestIntegrateDeployAuditUpdate(TestIntegrateBase):
    ...
    def _assert_get_value(
        self, from_addr: "Address", score_addr: "Address", func_name: str, value: int
    ):
        query_request = {
            "version": self._version,
            "from": from_addr,
    ...
    def test_score(self):
        ...
        self._assert_get_value(
            self._accounts[0], score_addr1, "get_value", value1 + value2
        )
    ...
    def test_invalid_owner(self):
        ...
        tx_results: List["TransactionResult"] = self.accept_score(
            tx_hash=tx_hash3, expected_status=False
        )
    ...
    def test_score_no_zip(self):
        ...
        tx_results: List["TransactionResult"] = self._deploy_score(
            score_name="install/update", value=value2, data=b"invalid", to_=score_addr1
        )
        tx_hash3 = tx_results[0].tx_hash
    ...
    def test_score_on_update_error(self):
        ...
        value2 = 2
        tx_results: List["TransactionResult"] = self._deploy_score(
            score_name="update/sample_score_on_update_error",
            value=value2,
            to_=score_addr1,
        )
        tx_hash3 = tx_results[0].tx_hash
    ...
    def test_score_no_python(self):
        ...
        value2 = 2
        tx_results: List["TransactionResult"] = self._deploy_score(
            score_name="install/sample_score_no_python", value=value2, to_=score_addr1
        )
        tx_hash3 = tx_results[0].tx_hash
    ...
    def test_prev_deploy_reject(self):
        ...
        value2 = 2
        tx_results: List["TransactionResult"] = self._deploy_score(
            score_name="update/sample_score", value=value2, to_=score_addr1
        )
        tx_hash3 = tx_results[0].tx_hash
        ...
        value3 = 3
        tx_results: List["TransactionResult"] = self._deploy_score(
            score_name="update/sample_score", value=value3, to_=score_addr1
        )
        ...
        self.reject_score(tx_hash=tx_hash3, expected_status=False)
        ...
        self._assert_get_value(
            self._accounts[0], score_addr1, "get_value", value1 + value3
        )
    ...
    def test_prev_deploy_accept(self):
        ...
        self.accept_score(tx_hash=tx_hash3, expected_status=False)
