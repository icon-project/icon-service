...
class TestIntegrateSendingIcx(TestIntegrateBase):
    def test_send_to_eoa(self):
        ...
        tx_results: List["TransactionResult"] = self.deploy_score(
            score_root="sample_score_sending_icx",
        ...
        tx_results: List["TransactionResult"] = self.score_call(
            ...
            to_=score_address,
            func_name="send",
            params={"_to": str(self._accounts[1].address), "_amount": hex(value)},
            value=value,
        )
        ...
        self.assertEqual(
            tx_results[0].event_logs[2].indexed[1],
            tx_results[0].event_logs[2].indexed[2],
        )
    ...
    def test_send_to_eoa_out_of_balance(self):
        ...
        tx_results: List["TransactionResult"] = self.score_call(
            ...
            to_=score_address,
            func_name="send",
            params={"_to": str(self._accounts[1].address), "_amount": hex(value * 2)},
            value=value,
        )
        ...
        # Checks if the msg is rolled back
        self.assertEqual(
            tx_results[0].event_logs[1].indexed[1],
            tx_results[0].event_logs[1].indexed[2],
        )
    ...
    def test_send_to_ca(self):
        ...
        tx_results: List["TransactionResult"] = self.score_call(
            ...
            func_name="send",
            params={"_to": str(receiving_score_address), "_amount": hex(value)},
            value=value,
        )
    ...
    def test_send_to_ca_out_of_balance(self):
        ...
        tx_results: List["TransactionResult"] = self.score_call(
            ...
            to_=sending_score_address,
            func_name="send",
            params={"_to": str(receiving_score_address), "_amount": hex(value * 2)},
            value=value,
        )
        # Checks if the result of icx.send
        self.assertEqual(tx_results[0].event_logs[0].indexed[1], False)
    ...
    def test_send_to_self(self):
        ...
        tx_results: List["TransactionResult"] = self.score_call(
            ...
            to_=sending_score_address,
            func_name="send",
            params={"_to": str(sending_score_address), "_amount": hex(value)},
            value=value,
        )
    ...
    def test_send_to_self_payable(self):
        ...
        # Checks if the msg is rolled back
        self.assertEqual(
            tx_results[0].event_logs[3].indexed[1],
            tx_results[0].event_logs[3].indexed[2],
        )
