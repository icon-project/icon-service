...
class SampleLinkScore(IconScoreBase):
    ...
    @eventlog(indexed=1)
    def BeforeInstall(self, msg_sender: Address):
        pass

    @eventlog(indexed=1)
    def AfterInstall(self, msg_sender: Address):
        pass
    ...
    def on_install(self, score_addr: "Address" = None) -> None:
        ...
        test_interface = self.create_interface_score(
            self._addr_score.get(), SampleInterface
        )
