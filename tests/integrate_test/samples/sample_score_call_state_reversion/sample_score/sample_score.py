...
class SampleScore(IconScoreBase):
    ...
    def __init__(self, db: IconScoreDatabase) -> None:
        ...
        self._should_handle_exception = VarDB(
            "_should_handle_exception", db, value_type=bool
        )
    ...
    def on_install(
        ...
        _shouldHandleException: bool = False,
    ) -> None:
        super().on_install()
    ...
    def invoke(self) -> None:
        ...
        print(
            f"context is readonly at {self._name.get()} start:{self._context.readonly}"
        )
    ...
    def handle_query(self):
        if self._next_address.get() is None:
            ...
            self.call(self._next_address.get(), self._next_function.get(), {})
