...
class TestChangeBlockHash(TestIISSBase):
    ...
    def test_change_block_hash(self):
        ...
        block, tx_rets = self.make_and_req_block_for_2_depth_invocation(tx_list=tx_list,
        ...
        self._write_precommit_state(new_block)
        ...
        RewardCalcProxy.rollback = Mock(return_value=(True, last_block.height, last_block.hash))
