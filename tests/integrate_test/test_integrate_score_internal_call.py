...
class TestIntegrateScoreInternalCall(TestIntegrateBase):
    ...
    def test_link_score_check_return_type1_revision3(self):
    ...
    def test_link_score_check_return_type2_revision3(self):
        governance_update_tx = self._make_deploy_tx("test_builtin", "0_0_4/governance",
                                                    self._admin, GOVERNANCE_SCORE_ADDRESS)
        prev_block, tx_results = self._make_and_req_block([governance_update_tx])
        self._write_precommit_state(prev_block)
    ...
    # case when query method call query method
    def test_link_score_check_return_type1_revision_lt_3(self):
        tx1 = self._make_deploy_tx("test_scores",
                                   "test_db_returns_default_value",
                                   self._addr_array[0],
                                   ZERO_SCORE_ADDRESS,
    ...
    # case when invoke method call query method
    def test_link_score_check_return_type2_revision_lt_3(self):
        value1 = 1 * self._icx_factor
        tx1 = self._make_deploy_tx("test_internal_call_scores/test_returns_wrong_type",
                                   "test_score",
                                   self._addr_array[0],
