...
def test_calculate_issuance_virtual_step_yellow_paper():
    for virtual_step_issuance_info in VIRTUAL_STEP_ISSUANCE_TABLE_FROM_YELLOW_PAPER:
        expected_issuance = _get_expected_issuance(virtual_step_issuance_info.deposit_icx,
...
def test_calculate_penalty_yellow_paper():
    ...
    remaining_virtual_step1 = \
        _get_expected_issuance(deposit_icx1, deposit_rate1) - \
    ...
    remaining_virtual_step2 =\
        _get_expected_issuance(deposit_icx2, deposit_rate2) - \
    ...
    remaining_virtual_step3 = \
        _get_expected_issuance(deposit_icx3, deposit_rate3) - \
    ...
    _assert_penalty(deposit_info_pair1[0], deposit_info_pair1[1], remaining_virtual_step1)
    _assert_penalty(deposit_info_pair2[0], deposit_info_pair2[1], remaining_virtual_step2)
    _assert_penalty(deposit_info_pair3[0], deposit_info_pair3[1], remaining_virtual_step3)
...
def _assert_penalty(agreement_info, current_agreement_info, remaining_virtual_step=0):
    ...
    expected_agreement_issuance_virtual_step = _get_expected_issuance(agreement_info.deposit_icx, agreement_info[2])
    expected_withdraw_issuance_virtual_step = _get_expected_issuance(current_agreement_info.deposit_icx,
                                                                     current_agreement_info.rate)
