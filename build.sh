...
if [[ ("$1" = "test" && "$2" != "--ignore-test") || ("$1" = "build") || ("$1" = "deploy") ]]; then
  ...
  wget "http://tbears.icon.foundation.s3-website.ap-northeast-2.amazonaws.com/iconcommons-0.9.4.5-py3-none-any.whl"
  pip install --force-reinstall iconcommons-0.9.4.5-py3-none-any.whl
  rm -rf iconcommons*
